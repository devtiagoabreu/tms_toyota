...
my $title    = &TMSstr::get_str( "LOOM_CLOCK_SETTING" );
...
print	"</table><BR>\n".
	...
	"<A HREF=\"setclock.cgi\"><IMG SRC=\"../image/back2_$lang.jpg\" width=85 height=27 alt=\"$str_BACK\" border=0></A>\n".
	"</NOBR><BR>\n".
	"</td></tr>\n".
	"</table><BR>\n".
