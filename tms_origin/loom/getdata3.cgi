...
my $title    = &TMSstr::get_str( "DATA_COLLECTION_NETWORK" );
...
print	"</table><BR>\n".
	...
	"<A HREF=\"getdata.cgi\"><IMG SRC=\"../image/back2_$lang.jpg\" width=85 height=27 alt=\"$str_BACK\" border=0></A>\n".
	"</NOBR><BR>\n".
	"</td></tr>\n".
	"</table><BR>\n".
